...
import { 
  ...
  Heart, Menu, X, ChevronLeft, ChevronRight, 
  BookOpen, Calendar, HelpCircle, LifeBuoy, LogOut,
  Bell, Search, User, Sparkles
} from 'lucide-react';
  ...
  const navGroups = [
    {
      ...
      items: [
        ...
        { href: '/student/chat', label: t('dashboard.messages'), icon: MessageSquare, badge: 2 },
      ]
    },
    {
      title: t('dashboard.learning') || (locale === 'fr' ? 'Apprentissage' : 'التعلم'),
      items: [
        ...
        { href: '/teachers', label: t('dashboard.findTeacher'), icon: Search },
      ]
    },
    {
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-20 items-center justify-between border-b bg-white px-6 lg:px-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/student/settings" className="hidden sm:flex items-center gap-3 rounded-xl hover:bg-gray-50 p-1.5 transition-all">
